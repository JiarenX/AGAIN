...
from utils import top_k_preds, cal_f1_score, load_blogcatalog
...
def train(args):
    ...
    # Load data
    adj_s, adj_train_s, features_s, labels_s, idx_train_s, idx_val_s, idx_test_s, idx_tot_s = load_blogcatalog(dataset=args.input_dataset,
                                                                                                               seed=args.seed)
    # model and optimizer
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dataset', type=str, default='blogcatalog')
